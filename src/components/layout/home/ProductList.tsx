    ...
    return (
      <section className="py-20 bg-gray-50 text-center">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-gray-500">Sản phẩm đặc biệt sẽ sớm được cập nhật</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-3 px-5 py-2 bg-blue-50 rounded-full mb-4">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Những sản phẩm công nghệ được yêu thích nhất – chất lượng cao cấp, giá tốt nhất
          </p>
          ...
          <Link href="/san-pham">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl"
            >
              Xem tất cả
        ...
        <div className="relative group">
          ...
          {/* Navigation arrows - chỉ hiện khi hover trên desktop */}
          {totalSlides > 1 && (
            <>
              <button
                onClick={goToPrev}
            ...
            {Array.from({ length: totalSlides }).map((_, i) => (
              <button
                ...
                className={`transition-all duration-300 ${
                  i === currentSlide
                    ? "w-10 h-2 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full"
